    ...
    <div className="space-y-6">
      ...
      <Card className="bg-card/80 border-border/50">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm flex items-center gap-2">
            ...
            <Badge variant="outline" className="text-[9px] ml-auto border-border text-muted-foreground">IA PRÉDICTIVE</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="bg-card/80 border-border/50">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-3">
            {[
              { label: "Temps de réponse", genie: "<2s", human: "47s" },
              { label: "Taux d'erreur", genie: "0%", human: "62%" },
      ...
      <div className="flex items-center gap-2 text-[10px] text-muted-foreground">
        ...
        <div className="ml-auto flex items-center gap-1">
          <div className="w-1.5 h-1.5 rounded-full bg-[hsl(var(--emerald))] animate-pulse"/>
          <span className="text-[hsl(var(--emerald))]">LIVE</span>
        </div>
      </div>
    </div>
  );
